...
# import eval_utils_interleaving
...
# opt.num_images=-1
# opt.cnn_model_path = ''
# opt.model_path = 'model-best_rt.pth'
# opt.infos_path = 'infos_topdown_rl-best_rt.pkl'
# opt.split = 'val'
# =======
opt.num_images = -1
...
opt.model_path = 'save_scst/model-best.pth'  # model-best.pth'
opt.infos_path = 'save_scst/infos-best.pkl'
opt.split = 'test'
opt.language_eval = 1
opt.stop_value = 0.5
opt.batch_size = 50
...
print('epoch: ',infos['epoch'],' iter:',infos['iter'])
...
if len(opt.id) == 0:
    opt.id = infos['opt'].id
ignore = ['input_fc_dir', 'input_att_dir', "id", "batch_size", "beam_size", "start_from", "language_eval", 'input_json',
          'input_label_h5','stop_value']
